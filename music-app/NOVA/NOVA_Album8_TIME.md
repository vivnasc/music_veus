# NOVA — Álbum VIII · TIME

**10 faixas · prompts Suno · cada faixa com som único**

*o tempo — a pressa, a eternidade, a criança que fomos, os mortos*
...
**Distinção deste álbum:** TIME é o álbum mais filosófico. Aqui NOVA atravessa as várias dimensões do tempo — a pressa moderna, a eternidade dos mortos, a criança que fomos, o velho que seremos. Os ritmos variam entre o muito lento (eternidade) e o frenético (pressa). Há mais momentos rituais, vozes faladas, peso temporal.
...
|---|-------|---------------|-----|---------|
| 01 | TICKING | Industrial pop urgente | 115 | Hino, abertura ansiosa |
| 02 | NINE YEARS OLD | Indie folk íntimo | 80 | Câmara, criança que fomos |
| 03 | RUSH | Drum and bass frenético | 130 | Hino, viral |
| 04 | DEAD | Spoken word + ambient | 60 | Ritual, mortos |
| 05 | OLD WOMAN | Folk eletrónico contemplativo | 75 | Câmara, futuro velho |
| 06 | SLOW | Ambient drone | 55 | Ritual, antídoto |
| 07 | YESTERDAY | Trip hop nostálgico | 85 | Câmara, passado |
| 08 | LATER | Synth-pop melancólico | 100 | Hino, adiamento |
| 09 | NOW | Hyperpop urgente | 120 | Hino, viral |
| 10 | ETERNAL | Post-rock cinematográfico | 65 | Ritual, fecho transcendente |

---

# 01 · TICKING

**Industrial pop urgente · 115 BPM · abertura ansiosa**

*Frase-bomba: "The clock is ticking but the soul is timeless"*
...
```
[Style: urgent industrial pop, dark electronic, distorted synth bass, mechanical clock sounds, glitchy textures, solo sharp vocal, NO choir]
...
**Indie folk íntimo · 80 BPM · criança que fomos**

*Frase-bomba: "I am sorry I left you, nine year old"*
...
```
[Style: intimate indie folk, fingerpicked guitar, brushed drums, warm bass, atmospheric pad, solo fragile tender vocal, NO choir]
...
**Drum and bass frenético · 130 BPM · viral**

*Frase-bomba: "I rushed through my own life and missed it"*

### STYLE

```
frenetic drum and bass, fast electronic, female-leaning androgynous solo vocal, sharp powerful lead, deep sub-bass, rapid breakbeats, urgent synth stabs, modern d&b production, no choir, English lead with European Portuguese whispers, Portugal accent NOT Brazilian, BPM 130, viral fierce frenetic
```
...
```
[Style: frenetic drum and bass, rapid breakbeats, deep sub-bass, urgent synths, solo sharp powerful vocal, NO choir]
...
**Spoken word + ambient · 60 BPM · ritual mortos**

*Frase-bomba: "The dead are not gone, the dead are slow"*
...
```
[Style: spoken word with ambient, deep drone, sparse piano, atmospheric pad, NO drums, NO choir]
...
**Folk eletrónico contemplativo · 75 BPM · futuro velho**

*Frase-bomba: "The old woman I will become is already inside me"*
...
```
[Style: contemplative folktronica, fingerpicked guitar, ambient pad, soft electronic textures, sparse percussion, solo warm grounded vocal, NO choir]
...
**Ambient drone · 55 BPM · antídoto**

*Frase-bomba: "Slow is the new radical"*
...
```
[Style: slow ambient drone, deep meditative, single synth pad, sparse piano, water sounds, NO drums, NO choir]
...
**Trip hop nostálgico · 85 BPM · passado**

*Frase-bomba: "I keep visiting yesterday like it's still home"*

### STYLE

```
nostalgic trip hop, melancholic downtempo, female-leaning androgynous solo vocal, breathy wistful lead, deep sub-bass, slow heavy drums, vintage sample, vinyl crackle, atmospheric pads, modern trip hop production, no choir, English lead with European Portuguese whispers, Portugal accent NOT Brazilian, BPM 85, nostalgic melancholic
```
...
```
[Style: nostalgic trip hop, deep sub-bass, slow drums, vintage sample, vinyl crackle, solo breathy wistful vocal, NO choir]
...
**Synth-pop melancólico · 100 BPM · adiamento**

*Frase-bomba: "Later was a country I never visited"*

### STYLE

```
melancholic synth-pop, sad pop anthem, female-leaning androgynous solo vocal, bright clear lead, atmospheric synthesizers, modern pop production, mid-tempo emotional, no choir, English lead with European Portuguese whispers, Portugal accent NOT Brazilian, BPM 100, viral sad pop
```
...
**Hyperpop urgente · 120 BPM · viral**

*Frase-bomba: "Now is the only address that has my key"*
...
```
[Style: urgent hyperpop, glitched electronic, distorted bass, fast kick, glitch fx, solo crystalline vocal with pitch effects, NO choir]
...
**Post-rock cinematográfico · 65 BPM · fecho transcendente**

*Frase-bomba: "I am living in the eternal disguised as a Tuesday"*
...
```
[Style: cinematic post-rock, slow build, ambient guitar + strings + electronic, climactic transcendent peak, solo prophetic voice, NO choir]
...
**1º Single:** NOW *(hyperpop viral, mensagem central)*

**2º Single:** RUSH *(d&b viral, hino geracional contra a pressa)*

**3º Single:** TICKING *(industrial pop, abertura)*

---

## Resumo do arco

TIME atravessa todas as dimensões temporais:
- A pressa moderna que nos rouba o presente (TICKING)
- A criança que abandonámos (NINE YEARS OLD)
- A loucura de viver à pressa (RUSH)
- Os mortos que continuam connosco (DEAD)
- A velha em nós que será o nosso futuro (OLD WOMAN)
- O lento como antídoto (SLOW)
- A nostalgia que nos prende ao passado (YESTERDAY)
- O adiamento que rouba a vida (LATER)
- O agora como única casa (NOW)
- O eterno que mora no quotidiano (ETERNAL)

A entrega central: **o tempo não é uma linha que corre. O tempo é uma profundidade onde habitamos. O agora é o lugar onde os mortos, a criança que fomos, a velha que seremos, e nós, vivemos juntos.**

---

*NOVA · Álbum VIII · TIME · 2026*
