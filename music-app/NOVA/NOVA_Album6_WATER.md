...
**10 faixas · prompts Suno · cada faixa com som único**

*a vulnerabilidade — atravessar a dor sem performar*

---

## Como usar

Cada faixa tem **3 blocos de código** prontos a copiar para o Suno.

1. **STYLE** → cola no campo *Style of Music*
2. **TITLE** → cola no campo *Title*
3. **LYRICS** → cola no campo *Lyrics*

**Constantes:**
- Mesma **Persona** criada a partir de "Antenna"
- **Português europeu** (Portugal accent NOT Brazilian)
- **Voz solo** predomina

**Distinção deste álbum:** WATER é o mais emocional. Aqui NOVA atravessa a dor — não performa, não embeleza, não evita. As faixas são lentas, predominantemente câmara, com momentos de hino mas sem festa. É o álbum para quem precisa de chorar.

---

## Mapa sonoro do álbum

| # | Faixa | Som dominante | BPM | Energia |
|---|-------|---------------|-----|---------|
| 01 | TEAR | Piano íntimo + cordas | 65 | Câmara, abertura crua |
| 02 | DROWN SLOW | Trip hop atmosférico | 75 | Câmara, asfixia lenta |
| 03 | DON'T SAVE ME | Indie alternative pop | 95 | Hino lento, declaração |
| 04 | SCAR | Folk eletrónico íntimo | 70 | Câmara, marca |
| 05 | HEAVY HEART | Soul electrónico lento | 80 | Câmara, gravidade |
| 06 | SALT | Ambient com voz nua | 55 | Câmara, choro nu |
| 07 | CARRY ME | Cinematic ballad orquestral | 70 | Hino lento, pedido |
| 08 | TIDE | Dream pop ondular | 85 | Câmara, ciclo |
| 09 | BREAK | Synth-pop tristonho | 100 | Hino viral, libertação |
| 10 | WRECK | Post-rock fecho cinemático | 60 | Ritual, naufrágio sereno |

---

# 01 · TEAR

**Piano íntimo + cordas · 65 BPM · abertura crua**

*Frase-bomba: "Let me cry without an explanation"*

### STYLE

```
intimate piano ballad with strings, cinematic chamber music, female-leaning androgynous solo vocal, fragile breaking voice, raw close-mic intimate, slow string build, no drums, no choir, English lead with European Portuguese whispers, Portugal accent NOT Brazilian, BPM 65, devastating raw
```
...
```
[Style: intimate piano ballad with strings, cinematic chamber, solo fragile vocal, NO drums, NO choir]
...
**Trip hop atmosférico · 75 BPM · asfixia lenta**

*Frase-bomba: "I'm drowning slow and you're checking your phone"*

### STYLE

```
trip hop atmospheric, dark electronic downtempo, female-leaning androgynous solo vocal, breathy melancholic lead, deep sub-bass, slow heavy drums, ambient pads, vinyl crackle, no choir, English lead with European Portuguese whispers, Portugal accent NOT Brazilian, BPM 75, asphyxiating melancholic
```
...
```
[Style: trip hop atmospheric, deep sub-bass, slow heavy drums, ambient pads, vinyl crackle, solo melancholic vocal, NO choir]
...
**Indie alternative pop · 95 BPM · declaração**

*Frase-bomba: "Don't save me, just stay with me"*

### STYLE

```
indie alternative pop, modern indie production, female-leaning androgynous solo vocal, intimate clear voice, electric guitar, atmospheric synths, brushed drums, mid-tempo emotional, no choir, English lead with European Portuguese whispers, Portugal accent NOT Brazilian, BPM 95, declarative anthem
```
...
```
[Style: indie alternative pop, electric guitar, atmospheric synths, brushed drums, solo intimate vocal, NO choir]
...
**Folk eletrónico íntimo · 70 BPM · marca**

*Frase-bomba: "The scar is not the failure, the scar is the proof you survived"*

### STYLE

```
intimate folk electronic, gentle folktronica, female-leaning androgynous solo vocal, warm tender voice, fingerpicked guitar, soft electronic textures, ambient pad, sparse percussion, no choir, English lead with European Portuguese whispers, Portugal accent NOT Brazilian, BPM 70, tender intimate
```
...
```
[Style: intimate folk electronic, fingerpicked guitar, soft electronic textures, ambient pad, sparse percussion, solo tender vocal, NO choir]
...
**Soul electrónico lento · 80 BPM · gravidade**

*Frase-bomba: "My heart is heavy and I'm not putting it down"*

### STYLE

```
slow electronic soul, neo-soul melancholic, female-leaning androgynous solo vocal, breathy powerful lead, deep bass, soft drum machine, electric piano, atmospheric pad, modern soul electronic, no choir, English lead with European Portuguese whispers, Portugal accent NOT Brazilian, BPM 80, soulful weight
```
...
```
[Style: slow electronic soul, neo-soul melancholic, deep bass, electric piano, solo powerful vocal, NO choir]
...
**Ambient com voz nua · 55 BPM · choro nu**

*Frase-bomba: "Salt water is the same in tears, sweat, and the sea"*

### STYLE

```
ambient with bare vocal, deep meditative, female-leaning androgynous solo vocal, sustained breath delivery, single deep synth pad, water sounds, no drums, no percussion, sound bath quality, no choir, English lead with European Portuguese whispers, Portugal accent NOT Brazilian, BPM 55, transcendent crying
```
...
```
[Style: ambient with bare vocal, deep meditative, single synth pad, water sounds, NO drums, NO percussion, NO choir]
...
**Cinematic ballad orquestral · 70 BPM · pedido**

*Frase-bomba: "Carry me, just for one mile"*

### STYLE

```
cinematic orchestral ballad, sweeping strings, female-leaning androgynous solo vocal, fragile pleading voice, full orchestra build, soft drums late, dramatic film score, no choir, English lead with European Portuguese whispers, Portugal accent NOT Brazilian, BPM 70, devastating cinematic
```
...
```
[Style: cinematic orchestral ballad, sweeping strings, full orchestra build, soft late drums, solo fragile vocal, NO choir]
...
**Dream pop ondular · 85 BPM · ciclo**

*Frase-bomba: "The pain comes back, but so does the peace"*
...
```
[Style: dream pop, atmospheric shoegaze, reverbed guitars, soft pads, solo ethereal vocal, NO choir]
...
**Synth-pop tristonho viral · 100 BPM · libertação**

*Frase-bomba: "Breaking is the only honest thing I've done this year"*

### STYLE

```
melancholic synth-pop, sad pop anthem, female-leaning androgynous solo vocal, bright clear voice, atmospheric synthesizers, modern pop production, mid-tempo emotional, no choir, English lead with European Portuguese whispers, Portugal accent NOT Brazilian, BPM 100, viral sad
```
...
```
[Style: melancholic synth-pop, sad pop anthem, atmospheric synths, solo bright vocal, NO choir]
...
**Post-rock fecho cinemático · 60 BPM · naufrágio sereno**

*Frase-bomba: "I was a beautiful wreck and the wreck was the beauty"*
...
```
[Style: post-rock cinematic, slow build, ambient guitar + strings + electronic, climactic transcendent peak, solo sustained voice, NO choir]
...
**1º Single:** BREAK *(synth-pop viral, mensagem citável)*

**2º Single:** DON'T SAVE ME *(indie pop, conceito imediato)*

**3º Single:** TEAR *(piano + cordas, abertura emocional devastadora)*

---

## Resumo do arco

WATER é o álbum mais vulnerável. NOVA atravessa a dor sem performar:
- O choro que não precisa de explicação (TEAR)
- A asfixia lenta da vida moderna (DROWN SLOW)
- O pedido de presença em vez de soluções (DON'T SAVE ME)
- A cicatriz como prova de vida (SCAR)
- O luto que se carrega como amor (HEAVY HEART)
- O choro como purificação corporal (SALT)
- O pedido de ser carregada (CARRY ME)
- A natureza cíclica da cura (TIDE)
- O quebrar como honestidade (BREAK)
- O naufrágio como beleza (WRECK)

A entrega central: **a dor não precisa de ser optimizada. A dor precisa de ser atravessada.**

---

*NOVA · Álbum VI · WATER · 2026*
