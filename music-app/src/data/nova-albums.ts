...
export const NOVA_ALBUMS: Album[] = [
  {
    ...
    tracks: [
    {
      number: 1,
      title: "ANTENNA",
      description: "Hino · 100 BPM · viral",
      lang: "EN" as const,
...
pousa o telemóvel`,
    ...
    },
    {
      ...
      description: "Hino · 110 BPM · viral · inversão (telemóvel canta)",
      lang: "EN" as const,
      energy: "anthem" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
acorda`,
    ...
    },
    {
      number: 3,
      title: "PREMIUM EMPTY",
      description: "Câmara · 70 BPM · íntima",
      lang: "EN" as const,
...
estou aqui`,
    ...
    },
    {
      number: 4,
      title: "MUTE",
      description: "Hino · 105 BPM · viral",
      lang: "EN" as const,
      energy: "anthem" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
silêncio`,
    ...
    },
    {
      number: 5,
      title: "SHOW ME",
      description: "Câmara · 75 BPM · intimista",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
guarda-te`,
    ...
    },
    {
      number: 6,
      title: "TIRED PRETTY",
      description: "Câmara · 72 BPM · vulnerável",
      lang: "EN" as const,
...
e isso chega`,
    ...
    },
    {
      number: 7,
      title: "COMPARE",
      description: "Hino · 108 BPM · viral",
      lang: "EN" as const,
      energy: "anthem" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
e basta`,
    ...
    },
    {
      ...
      description: "Ritual · 65 BPM · longa",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
sois mais que isso`,
    ...
    },
    {
      ...
      description: "Cântico · 80 BPM · curto · mantra",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
estás aqui`,
    ...
    },
    {
      number: 10,
      title: "STATIC",
      description: "Ritual · 70 BPM · fecho do álbum",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
(final breath)`,
  ...
  },
  {
    ...
    tracks: [
    {
      number: 1,
      title: "SKIN",
      description: "R&B alternativo sensorial · 85 BPM · abertura",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
estou em casa`,
    ...
    },
    {
      number: 2,
      title: "BREATHE",
      description: "Ambient orgânico, respiração · 60 BPM · meditativo",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
estou aqui`,
    ...
    },
    {
      number: 3,
      title: "HUNGRY",
      description: "Soul electrónico pulsante · 95 BPM · hino",
      lang: "EN" as const,
      energy: "anthem" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
vou comer`,
    ...
    },
    {
      number: 4,
      title: "HEAVY",
      description: "Trip hop denso · 75 BPM · câmara",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
larguei`,
    ...
    },
    {
      number: 5,
      title: "TOUCH",
      description: "Synth-pop táctil viral · 108 BPM · hino",
      lang: "EN" as const,
      energy: "anthem" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
estou aqui`,
    ...
    },
    {
      ...
      description: "Piano + cordas devastador · 65 BPM · câmara",
      lang: "EN" as const,
      energy: "raw" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
e está tudo bem`,
    ...
    },
    {
      number: 7,
      title: "BONE",
      description: "Drum and bass minimal · 90 BPM · ritual breve",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
e basta`,
    ...
    },
    {
      number: 8,
      title: "SOFT ANIMAL",
      description: "Folk dreamy · 72 BPM · câmara",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
e basta`,
    ...
    },
    {
      number: 9,
      title: "HOME OF FLESH",
      description: "Spoken word + electrónica · 70 BPM · cântico",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
finalmente em casa`,
    ...
    },
    {
      number: 10,
      title: "INHALE",
      description: "Drone ambient · 55 BPM · fecho",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
(final breath, deep)`,
  ...
  },
  {
    ...
    tracks: [
    {
      number: 1,
      title: "ALGORITHM",
      description: "Electrónica industrial fria · 110 BPM · abertura",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
ainda estou aqui`,
    ...
    },
    {
      number: 2,
      title: "DEAR AI",
      description: "Synth balada com vocoder · 80 BPM · câmara",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
volto à humanidade`,
    ...
    },
    {
      number: 3,
      title: "AVATAR",
      description: "Hyperpop glitchado · 120 BPM · viral",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
sem avatar`,
    ...
    },
    {
      ...
      description: "Trap melódico distorcido · 90 BPM · ferida",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
ainda sou real`,
    ...
    },
    {
      number: 5,
      title: "LOGIN",
      description: "Ambient drone meditativo · 65 BPM · ritual de entrada",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
saí`,
    ...
    },
    {
      number: 6,
      title: "ROBOT CRY",
      description: "Indie electrónico melancólico · 75 BPM · máquina que sente",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
chorei`,
    ...
    },
    {
      number: 7,
      title: "CLOUD MEMORY",
      description: "Dream pop atmosférico · 85 BPM · memória etérea",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
o corpo lembra`,
    ...
    },
    {
      number: 8,
      title: "UPDATE ME",
      description: "Electroclash punk · 115 BPM · viral urgência",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
e basta`,
    ...
    },
    {
      number: 9,
      title: "LAST HUMAN",
      description: "Post-rock ambient longo · 60 BPM · ritual profecia",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
e o primeiro`,
    ...
    },
    {
      number: 10,
      title: "REBOOT",
      description: "Cântico minimal eletrónico · 70 BPM · fecho/recomeço",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
recomecei`,
  ...
  },
  {
    ...
    tracks: [
    {
      number: 1,
      title: "EMPTY ROOM",
      description: "Piano + cordas devastador · 60 BPM · abertura",
      lang: "EN" as const,
      energy: "raw" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
estou aqui`,
    ...
    },
    {
      number: 2,
      title: "READ AT 3AM",
      description: "R&B alternativo lento · 80 BPM · ferida íntima",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
desactivei`,
    ...
    },
    {
      number: 3,
      title: "CROWD",
      description: "Synth-pop melancólico · 100 BPM · viral",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
volto a mim`,
    ...
    },
    {
      ...
      description: "Folk eletrónico atmosférico · 70 BPM · espectral",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
ela sou eu`,
    ...
    },
    {
      ...
      description: "Hyperpop suave triste · 105 BPM · contradição",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
preciso de gente`,
    ...
    },
    {
      ...
      description: "Indie pop confessional · 85 BPM · narrativa",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
ainda à espera`,
    ...
    },
    {
      number: 7,
      title: "THERAPY",
      description: "Spoken word + jazz eletrónico · 75 BPM · processo",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
queres saber?`,
    ...
    },
    {
      number: 8,
      title: "QUIET",
      description: "Drone ambient meditativo · 55 BPM · silêncio",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
(final breath)`,
    ...
    },
    {
      ...
      description: "Trip hop dupla pessoa · 80 BPM · paradoxo",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
encontra-me`,
    ...
    },
    {
      number: 10,
      title: "ECHO",
      description: "Post-rock crescendo final · 65 BPM · fecho",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
estou aqui`,
  ...
  },
  {
    ...
    tracks: [
    {
      number: 1,
      title: "BURN IT",
      description: "Industrial pop drop pesado · 110 BPM · abertura",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
e nasci`,
    ...
    },
    {
      number: 2,
      title: "PRETTY LIE",
      description: "Dark pop electrónico · 95 BPM · denúncia",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
mesmo sem likes`,
    ...
    },
    {
      number: 3,
      title: "SYSTEM",
      description: "Drum and bass furioso · 130 BPM · viral",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
imagina outro mundo`,
    ...
    },
    {
      number: 4,
      title: "NOT YOURS",
      description: "Synth-rock distorcido · 105 BPM · declaração",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
e basta`,
    ...
    },
    {
      ...
      description: "Electroclash sarcástico · 115 BPM · viral",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
falo na mesma`,
    ...
    },
    {
      ...
      description: "Hyperpop agressivo · 125 BPM · viral",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
novo sistema`,
    ...
    },
    {
      ...
      description: "Folk eletrónico denso · 75 BPM · confronto íntimo",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
finalmente livre`,
    ...
    },
    {
      number: 8,
      title: "CANCEL ME",
      description: "Pop punk eletrónico · 120 BPM · provocação",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
ainda aqui`,
    ...
    },
    {
      number: 9,
      title: "IDENTITY WARS",
      description: "Trip hop denso · 85 BPM · reflexão",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
sou tudo`,
    ...
    },
    {
      number: 10,
      title: "ASHES",
      description: "Post-rock ascensão · 70 BPM · fecho transcendente",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
nasci do fogo`,
  ...
  },
  {
    ...
    tracks: [
    {
      number: 1,
      title: "TEAR",
      description: "Piano íntimo + cordas · 65 BPM · abertura crua",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
e está tudo bem`,
    ...
    },
    {
      number: 2,
      title: "DROWN SLOW",
      description: "Trip hop atmosférico · 75 BPM · asfixia lenta",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
finalmente`,
    ...
    },
    {
      number: 3,
      title: "DON'T SAVE ME",
      description: "Indie alternative pop · 95 BPM · declaração",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
fica`,
    ...
    },
    {
      number: 4,
      title: "SCAR",
      description: "Folk eletrónico íntimo · 70 BPM · marca",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
sobrevivi`,
    ...
    },
    {
      number: 5,
      title: "HEAVY HEART",
      description: "Soul electrónico lento · 80 BPM · gravidade",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
amo-os ainda`,
    ...
    },
    {
      number: 6,
      title: "SALT",
      description: "Ambient com voz nua · 55 BPM · choro nu",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
(final breath)`,
    ...
    },
    {
      number: 7,
      title: "CARRY ME",
      description: "Cinematic ballad orquestral · 70 BPM · pedido",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
e respirei`,
    ...
    },
    {
      number: 8,
      title: "TIDE",
      description: "Dream pop ondular · 85 BPM · ciclo",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
volta tudo`,
    ...
    },
    {
      number: 9,
      title: "BREAK",
      description: "Synth-pop tristonho viral · 100 BPM · libertação",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
e está tudo bem`,
    ...
    },
    {
      number: 10,
      title: "WRECK",
      description: "Post-rock fecho cinemático · 60 BPM · naufrágio sereno",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
no naufrágio`,
  ...
  },
  {
    ...
    tracks: [
    {
      number: 1,
      title: "AIR",
      description: "Synth-pop luminoso · 110 BPM · abertura solar",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
sou ar`,
    ...
    },
    {
      number: 2,
      title: "LAUGH",
      description: "Indie pop alegre · 115 BPM · viral",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
ri sempre`,
    ...
    },
    {
      number: 3,
      title: "DANCE ANYWAY",
      description: "House melódico angelical · 120 BPM · viral",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
ainda danço`,
    ...
    },
    {
      number: 4,
      title: "FREE",
      description: "Folk pop expansivo · 95 BPM · libertação",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
finalmente`,
    ...
    },
    {
      number: 5,
      title: "FLY",
      description: "Synth-pop etéreo · 100 BPM · ascensão",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
voo`,
    ...
    },
    {
      number: 6,
      title: "SUN",
      description: "Tropical electronic · 105 BPM · calor",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
sou luz`,
    ...
    },
    {
      number: 7,
      title: "HOLY PARTY",
      description: "Disco-pop sagrado · 118 BPM · viral",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
para Deus`,
    ...
    },
    {
      number: 8,
      title: "LIGHT BODY",
      description: "Dream pop ascensão · 90 BPM · leveza",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
sou luz`,
    ...
    },
    {
      number: 9,
      title: "PLAY",
      description: "Synth-pop infantil · 108 BPM · brincadeira",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
brinco`,
    ...
    },
    {
      number: 10,
      title: "LEVITATE",
      description: "Eurodance angelical · 125 BPM · fecho viral",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
levito`,
  ...
  },
  {
    ...
    tracks: [
    {
      number: 1,
      title: "TICKING",
      description: "Industrial pop urgente · 115 BPM · abertura ansiosa",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
o agora basta`,
    ...
    },
    {
      ...
      description: "Indie folk íntimo · 80 BPM · criança que fomos",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
estás em mim`,
    ...
    },
    {
      number: 3,
      title: "RUSH",
      description: "Drum and bass frenético · 130 BPM · viral",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
pára`,
    ...
    },
    {
      number: 4,
      title: "DEAD",
      description: "Spoken word + ambient · 60 BPM · ritual mortos",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
obrigada, avô`,
    ...
    },
    {
      number: 5,
      title: "OLD WOMAN",
      description: "Folk eletrónico contemplativo · 75 BPM · futuro velho",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
ela guia-me`,
    ...
    },
    {
      number: 6,
      title: "SLOW",
      description: "Ambient drone · 55 BPM · antídoto",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
devagar`,
    ...
    },
    {
      number: 7,
      title: "YESTERDAY",
      description: "Trip hop nostálgico · 85 BPM · passado",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
volto a hoje`,
    ...
    },
    {
      number: 8,
      title: "LATER",
      description: "Synth-pop melancólico · 100 BPM · adiamento",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
começo agora`,
    ...
    },
    {
      number: 9,
      title: "NOW",
      description: "Hyperpop urgente · 120 BPM · viral",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
sempre agora`,
    ...
    },
    {
      number: 10,
      title: "ETERNAL",
      description: "Post-rock cinematográfico · 65 BPM · fecho transcendente",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
e é tudo o mesmo`,
  ...
  },
  {
    ...
    tracks: [
    {
      number: 1,
      title: "NO ARMOR",
      description: "Neo-soul cinematográfico · 80 BPM · abertura",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
finalmente nu`,
    ...
    },
    {
      number: 2,
      title: "MOTHER",
      description: "Folk eletrónico íntimo · 70 BPM · mãe",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
amo-te`,
    ...
    },
    {
      number: 3,
      title: "FRIEND",
      description: "Indie pop quente · 95 BPM · viral",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
amigos`,
    ...
    },
    {
      ...
      description: "R&B alternativo · 85 BPM · declaração",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
hoje, sempre, hoje`,
    ...
    },
    {
      number: 5,
      title: "CHILD",
      description: "Jazz electrónico íntimo · 75 BPM · ao filho",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
sou tua para sempre`,
    ...
    },
    {
      number: 6,
      title: "STRANGER",
      description: "Synth-pop expansivo · 105 BPM · viral",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
és minha`,
    ...
    },
    {
      number: 7,
      title: "LOVE THE DEAD",
      description: "Cinematic ballad orquestral · 65 BPM · luto",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
sempre`,
    ...
    },
    {
      number: 8,
      title: "SELF",
      description: "Soul electrónico · 90 BPM · ao próprio",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
finalmente`,
    ...
    },
    {
      number: 9,
      title: "OPEN",
      description: "Indie folk pop · 100 BPM · libertação",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
abro`,
    ...
    },
    {
      number: 10,
      title: "ALL",
      description: "Post-rock cinematográfico · 70 BPM · fecho cósmico",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
amo tudo`,
  ...
  },
  {
    ...
    tracks: [
    {
      number: 1,
      title: "LIGHT",
      description: "Cinematic ascensão · 80 BPM · abertura luminosa",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
sempre fui luz`,
    ...
    },
    {
      number: 2,
      title: "I AM ENOUGH",
      description: "Soul ballad · 75 BPM · declaração final",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
basto, basto, basto`,
    ...
    },
    {
      number: 3,
      title: "LET GO",
      description: "Indie folk íntimo · 85 BPM · libertação",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
estou leve`,
    ...
    },
    {
      number: 4,
      title: "TRUST",
      description: "Ambient com voz nua · 60 BPM · entrega",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
confio`,
    ...
    },
    {
      number: 5,
      title: "THE MESSAGE",
      description: "Spoken word + cordas · 65 BPM · profecia central",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
és aqui`,
    ...
    },
    {
      number: 6,
      title: "THANK YOU",
      description: "Acoustic com cordas · 70 BPM · gratidão",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
para sempre`,
    ...
    },
    {
      number: 7,
      title: "DISAPPEAR",
      description: "Drone ambient longo · 55 BPM · desaparecimento",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
agora`,
    ...
    },
    {
      number: 8,
      title: "SEED",
      description: "Folk eletrónico esperançoso · 90 BPM · herança",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
o resto é teu`,
    ...
    },
    {
      number: 9,
      title: "LAST SONG",
      description: "Cinematic ballad · 65 BPM · última canção",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
...
adeus`,
    ...
    },
    {
      number: 10,
      title: "SILENCE",
      description: "Ambient + silêncio · 50 BPM · fecho absoluto",
      lang: "EN" as const,
      energy: "whisper" as TrackEnergy,
      flavor: null,
      vocalMode: "solo" as VocalMode,
