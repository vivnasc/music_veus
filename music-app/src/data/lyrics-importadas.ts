// AUTO-GERADO por scripts/build-imported-lyrics.ts
// Não editar à mão — as fontes de verdade são os .md em /LETRAS-IMPORTADAS/.
// Para regenerar: cd music-app && npx tsx scripts/build-imported-lyrics.ts
//
// Última geração: 2026-04-24T13:17:00.211Z
// 30 letras em 3 ficheiro(s).
...
Foi o melhor
De hoje`,
  // nua-boa/8 — Whole Evening (pele-boa-letras.md)
  "nua-boa/8": `[Verse 1]
...
Just this
Just enough`,
  // nua-boa/9 — Mereci (pele-boa-letras.md)
  "nua-boa/9": `[Verse 1]
...
E amanhã
Mereço outra vez`,
  // nua-boa/10 — Boa (pele-boa-letras.md)
  "nua-boa/10": `[Verse 1]
...
É o único dia
Que existe`,
  // nua-inteira/1 — Antes de Entrar (pele-inteira-letras.md)
...
Depois
Entro`,
  // nua-inteira/2 — Too Loud (pele-inteira-letras.md)
...
That never
Ends`,
  // nua-inteira/5 — Demais (pele-inteira-letras.md)
...
She's ever done`,
  // nua-inteira/7 — Espelho (pele-inteira-letras.md)
...
Acreditar
Na versão dela`,
  // nua-inteira/8 — Don't Fix Me (pele-inteira-letras.md)
...
Without
A screwdriver`,
  // nua-inteira/9 — Mãos de Mãe (pele-inteira-letras.md)
...
E ninguém
Me disse`,
  // nua-inteira/10 — Inteira (pele-inteira-letras.md)
...
Finalmente
Inteira`,
  // nua-por-dentro/1 — Forte (pele-por-dentro-letras.md)
...
Que é um peso
Não é um elogio`,
  // nua-por-dentro/2 — Three AM (pele-por-dentro-letras.md)
...
That knows
My name`,
  // nua-por-dentro/3 — Ninguém Pergunta (pele-por-dentro-letras.md)
...
That comes through
Is mine`,
  // nua-por-dentro/5 — Peso Invisível (pele-por-dentro-letras.md)
...
Sozinha
Com tudo`,
  // nua-por-dentro/8 — Glass Woman (pele-por-dentro-letras.md)
...
And done
Performing`,
  // nua-por-dentro/9 — Medo Que Não Se Diz (pele-por-dentro-letras.md)
...
É a única resposta
Que conheço`,
  // nua-por-dentro/10 — Ainda Aqui (pele-por-dentro-letras.md)
