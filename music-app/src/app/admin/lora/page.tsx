...
const TRAINING_SCENES = [
  "standing in a dark room, backlit by warm amber light, fabric billowing",
  "sitting by a window, golden light filtering through layers of veil",
  "walking through morning fog on a quiet street, silhouette from behind",
  "standing at the edge of the ocean at sunset, veil caught by wind",
  "seated at a piano, draped in fabric, seen from behind, candlelight",
  "standing in a doorway, backlit silhouette, golden light streaming in",
  "in a field of tall grass at golden hour, figure seen from a distance",
  "leaning against a stone wall, face turned away, warm side lighting",
  "kneeling in a dark chapel, votive candles, golden fabric pooling on floor",
  "standing on a rooftop at dusk, city lights behind, veil flowing in wind",
  "walking through rain, golden umbrella, fabric clinging, seen from behind",
  "at a cafe table, hands wrapped around a cup, face obscured by heavy fabric",
  "standing in a forest clearing, dappled golden light through trees",
  "dancing alone in an empty ballroom, fabric spinning, golden dust in air",
  "sitting on stone steps of an old church, head bowed, veil pooling",
  "reading a book in a dark library, face completely hidden by draped fabric",
  "standing before a large window at dawn, silhouette only, amber sky",
  "lying on a dark surface, completely draped, only fabric shapes visible",
  "walking through a narrow alley in Lisbon, warm evening light, from behind",
  "standing in shallow water at the beach, golden hour, fabric floating",
  "in a garden of white flowers, veiled figure from a distance, golden haze",
  "playing violin, seen from behind, fabric flowing, warm spotlight",
  "standing in the rain, street lamps behind, translucent wet fabric",
  "meditating cross-legged, layers of fabric, candles around, overhead view",
];
