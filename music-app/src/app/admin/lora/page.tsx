...
const TRAINING_SCENES = [
  "woman with golden veil, seen from behind in a dark room, warm amber backlight, fabric billowing",
  "woman sitting by a window, turned away from camera, golden fabric flowing, warm afternoon light",
  "woman walking through morning fog, seen from behind, golden veil trailing behind her",
  "woman at the ocean at sunset, silhouette against the light, veil caught by wind",
  "woman at a piano, seen from behind, golden fabric draped over shoulders, candlelight",
  "woman in a doorway, backlit silhouette, golden light streaming around her figure",
  "woman in tall grass at golden hour, seen from a distance, veil flowing in wind",
  "woman leaning against stone wall, face in deep shadow, warm golden side lighting",
  "woman kneeling in a chapel, head bowed, golden fabric pooling on floor, candlelight",
  "woman on a rooftop at dusk, seen from behind, city lights below, veil in wind",
  "woman walking through rain, seen from behind, golden fabric flowing, wet cobblestones",
  "woman at a cafe table, turned to look out window, face in shadow, golden tones",
  "woman in a forest clearing, dappled golden light, silhouette between trees",
  "woman dancing alone, seen from above, golden fabric spinning around her",
  "woman sitting on stone steps, head bowed, golden fabric cascading, warm light",
  "woman holding a book, face turned down in shadow, warm library light",
  "woman before a large window at dawn, silhouette against amber sky",
  "woman lying on a dark surface, seen from above, golden fabric draped elegantly",
  "woman walking through a narrow Lisbon alley, seen from behind, golden evening light",
  "woman in shallow water at the beach, silhouette at golden hour, fabric floating",
  "woman in a garden, seen from a distance through flowers, golden warm haze",
  "woman with guitar, seen from behind, warm spotlight from above, golden tones",
  "woman standing in rain, silhouette against street lamps, golden reflections",
  "woman meditating cross-legged, seen from behind, candles around, golden fabric",
];
