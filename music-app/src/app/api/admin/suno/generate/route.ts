...
function buildStyle(energy?: string, flavor?: string, prompt?: string): string {
  ...
  const flavorGenre: Record<string, string> = {
    organic: "",
    marrabenta: "Afropop, upbeat, 115 BPM, syncopated drums, bright percussion, punchy bass, log drum, shaker loops, bouncy, celebratory, call-and-response chants, ululating vocals, vocal ad-libs, frenetic energy",
